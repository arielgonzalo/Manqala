class ProductsController < ApplicationController
  ...
  def destroy
    @product.destroy
    respond_to do |format|
      format.html { redirect_to products_index_url, notice: 'Product was successfully destroyed.' }
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :description, :price, :category_id, :photo)
    end
