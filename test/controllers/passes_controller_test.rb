...
class PassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pass" do
    assert_difference('Pass.count') do
      post passes_url, params: { pass: { client_id: @pass.client_id, end_time: @pass.end_time, start_time: @pass.start_time } }
    end
  ...
  test "should update pass" do
    patch pass_url(@pass), params: { pass: { client_id: @pass.client_id, end_time: @pass.end_time, start_time: @pass.start_time } }
