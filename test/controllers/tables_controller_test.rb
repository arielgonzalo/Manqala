...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { is_outdoor: @table.is_outdoor, location: @table.location, name: @table.name } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { is_outdoor: @table.is_outdoor, location: @table.location, name: @table.name } }
