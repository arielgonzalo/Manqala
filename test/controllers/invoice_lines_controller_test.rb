...
class InvoiceLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invoice_line" do
    assert_difference('InvoiceLine.count') do
      post invoice_lines_url, params: { invoice_line: { invoice_id: @invoice_line.invoice_id, pass_id: @invoice_line.pass_id, product_id: @invoice_line.product_id, quantity: @invoice_line.quantity, total_price: @invoice_line.total_price, unit_price: @invoice_line.unit_price, unit_total_price: @invoice_line.unit_total_price } }
    end
  ...
  test "should update invoice_line" do
    patch invoice_line_url(@invoice_line), params: { invoice_line: { invoice_id: @invoice_line.invoice_id, pass_id: @invoice_line.pass_id, product_id: @invoice_line.product_id, quantity: @invoice_line.quantity, total_price: @invoice_line.total_price, unit_price: @invoice_line.unit_price, unit_total_price: @invoice_line.unit_total_price } }
